    ...
    model {
        ...
        enronFts = softwareSystem "Enron Email FTS" "Provides full-text search with semantic and relational queries over the Enron email dataset." {
            ...
            api = container "API" "HTTP API exposing search functionality over the network." "Kotlin / Ktor" {
                ...
                dtos = component "DTO Interfaces" "Data transfer objects for API request/response serialization (list vs detail DTOs), synced with frontend via OpenAPI."
            }
        ...
        searchCore -> luceneClass "Queries"
        searchCore -> databaseClass "Fetches emails from"
        ...
        cliClass -> databaseClass "Reads emails for indexing from"
        ...
        luceneClass -> databaseClass "Reads emails for indexing from"
    }
